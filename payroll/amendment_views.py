...
def apply_amendment_batch(request, batch_id):
    ...
    with transaction.atomic():
        ...
        for src in baseline_payslips:
            ...
            if ((src.employee.status == Employee.Status.TERMINATED or src.employee.is_archived)
            ...
            # employees; overwritten in step 3 for touched ones).
