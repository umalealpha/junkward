...
const DESTS: Dest[] = [
  // Core
  { label: 'Dashboard', href: '/dashboard', group: 'Core', kw: 'home kpi overview' },
  ...
  { label: 'Adoption Scoreboard', href: '/adoption', group: 'Core', kw: 'usage adoption who using excel resistance' },
  { label: 'Graphite Aware', href: '/aware', group: 'Core', kw: 'ai ask nl sql claims payability kyc' },
  { label: 'Smart Entry / Quick Entry', href: '/quick-entry', group: 'Core', kw: 'journal manual upload tb je expense payment' },
  { label: 'Tasks', href: '/tasks', group: 'Core' },
  { label: 'My League', href: '/my-league', group: 'Core', kw: 'my league score rank reward incentive points task confirm waiting bwp fortnight standing' },
  { label: 'Task Dashboard', href: '/task-dashboard', group: 'Core', kw: 'tasks oversight completion feedback team overdue planning' },
  ...
  { label: 'Refunds', href: '/refunds', group: 'Core', kw: 'refund reimbursement expense claim starlink travel invoice payment' },
  ...
  { label: 'Talent Cockpit', href: '/hris/talent-cockpit', group: 'People', kw: 'talent cockpit development dialogue performance evaluation nine box' },
  { label: 'Manager Scorecard', href: '/hris/manager-scorecard', group: 'People', kw: 'manager scorecard leadership rating team' },
  { label: 'Spend Requests', href: '/spend-requests', group: 'Core', kw: 'event golf party training travel advance budget approval spend deepseek broker birthday entertainment sponsorship' },
  { label: 'Payment Requests', href: '/payment-requests', group: 'Core', kw: 'payment authorisation authorization pay approve cfo paye premium cession towing beneficiary payee bank transfer release funds' },
  { label: 'My Requests', href: '/my-requests', group: 'Core', kw: 'my requests status track leave loan petty cash payment application submitted where is it progress pending whose desk' },
  { label: 'My Approvals', href: '/my-approvals', group: 'Core', kw: 'approvals approve inbox pending sign off signoff refunds spend purchase order queue awaiting' },
  ...
  { label: 'Commissions', href: '/commissions', group: 'Accounting', kw: 'commission agent independent bdu payout withholding monthly submission form' },
  ...
  { label: 'Nine-Box Grid', href: '/hris/ninebox', group: 'People', kw: 'talent' },
  { label: 'Succession', href: '/hris/succession', group: 'People' },
  { label: 'Development Dialogue (mine)', href: '/hris/my-dialogue', group: 'People' },
  { label: 'Team Dialogues', href: '/hris/team-dialogues', group: 'People' },
