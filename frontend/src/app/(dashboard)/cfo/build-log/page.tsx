...
export default function BuildLogPage() {
  ...
  }, [date, who, area, bugsOnly, q])

  useEffect(() => { void load() }, [load])

  const anyFilter = !!(who || area || bugsOnly || q)
  const clear = () => { setWho(''); setArea(''); setBugsOnly(false); setQ('') }
    ...
    <div>
      ...
      <div style={{ padding: '18px 20px 40px', maxWidth: 1180, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <Stat T={T} label="Still to finish" value={data?.counts.still_open ?? 0}
