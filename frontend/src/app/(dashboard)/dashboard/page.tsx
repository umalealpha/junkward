...
// ─── Count-up hook (redesign pack 03) ───────────────────────────────────────
// Purely presentational: animates a number from 0 → target once on mount via
// requestAnimationFrame (no library). Fed by the REAL value already computed
// for each KPI — never invents data. Honours reduce-motion by snapping to the
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-1 p-6 space-y-6" style={{ maxWidth: 1440 }}>
        ...
        {/* ─── Row 5: Morning-brief notes (CFO 2026-09-10) ───────────────
