          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-[#F4F4F5]">
                {loading ? (
                  <tr><td colSpan={11} className="px-4 py-12 text-center text-[#A0A0AB]">Loading…</td></tr>
                ) : (data?.results || []).length === 0 ? (
                  <tr><td colSpan={11} className="px-4 py-12 text-center text-[#A0A0AB]">No claims match these filters.</td></tr>
                ) : data!.results.map(c => (
