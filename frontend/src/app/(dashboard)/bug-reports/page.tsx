      ...
      <CardContent className="py-4">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center gap-3 mt-2 text-xs text-[#9CA3AF] flex-wrap">
          ...
          <div className="mt-4 pt-4 border-t border-[#F3F4F6] grid grid-cols-1 sm:grid-cols-[180px_1fr_auto] gap-3 items-end">
            ...
            <div>
              <label className="block text-xs text-[#374151] font-medium mb-1">
                Resolution note <span className="text-[#9CA3AF]">(emailed to the reporter on status change)</span>
              </label>
    ...
    <div className="flex flex-col min-h-screen">
      <TopBar title="Bug Reports" breadcrumbs={[{ label: 'Bug Reports' }]}
        actions={
          <div className="flex items-center gap-2">
            {lastSync && (
              <span className="hidden sm:inline text-xs text-[#9CA3AF]">
      ...
      <div className="flex-1 p-6 max-w-4xl w-full mx-auto space-y-4">
        ...
        {loading ? (
          ...
          <Card><CardContent className="py-12 text-center text-[#9CA3AF]">
