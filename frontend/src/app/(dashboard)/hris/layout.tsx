...
const SELF_SERVICE_ROUTES = ['/hris', '/hris/leave', '/hris/payslips', '/hris/profile', '/hris/letters', '/hris/pip', '/hris/staff-loans', '/hris/leave-encashment', '/hris/disciplinary', '/hris/my-dialogue', '/hris/team-dialogues', '/hris/talent-cockpit', '/hris/pulse', '/hris/my-brief', '/hris/incentives']
