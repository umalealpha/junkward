...
export default function LoginPage() {
  ...
  return (
    <AccessPortalShell>
      ...
      {/* Wording from the CFO's supplied design (2026-09-08). FROZEN. */}
      <p className="oap-sub">
        One source of truth for Alpha Direct. Email and password is the quick,
      ...
      <a href="/staff-login" className={OAP.primaryBtn}>Sign in with email &amp; password</a>
      <div style={{ marginTop: 9, textAlign: 'center', fontSize: 11, color: '#8a4b00' }}>
        Recommended — this is the quick way in.
      </div>
