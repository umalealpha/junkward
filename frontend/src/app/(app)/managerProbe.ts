...
export interface GlanceCounts { in: number; on_leave: number; dark: number; overdue: number }
export interface Glance { as_of: string; reports: GlanceReport[]; counts: GlanceCounts }
