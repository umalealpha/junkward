...
class FeedTestBase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        PayrollPeriod.objects.create(period_name='2026-05',
...
class FeedLogicTests(FeedTestBase):
    ...
    def test_no_payroll_period_yet(self):
        self._approved_request(period='2026-09', lines=[(self.empA, '100.00')])
        res = feed_period_company(period_label='2026-09', company=self.co, user=self.maker)
