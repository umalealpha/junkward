...
KNOWN_REASONS: dict[str, dict[str, str]] = {
    ...
    'AC06': {
        'plain': 'The account is blocked and cannot receive money.',
        'action': 'The payee has to sort this out with their own bank. Hold the '
                  'payment until they confirm it is lifted.',
        'ours': 'no',
    },
    'AM04': {
