    ...
    def handle(self, *args, **opts):
        ...
        for parsed in paid:
            ...
            if action == 'close':
                ...
                res = _mark_paid_from_bank(pr, user, decision['reason']) if pr else None
                if res is not None:
                    closed += 1
                    ...
                    # Left PENDING_CFO in a parallel action between read and close.
                    self.stdout.write(f'  · {decision["request_ref"]} no longer '
                                      f'pending — skipped')
