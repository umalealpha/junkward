...
from core.approvals_views import (my_approvals, my_approval_items, bulk_approve,
                                   ...
                                   approval_brief, push_vapid_key, push_subscribe)
from core.request_tracker_views import my_requests_view
...
from core.api_views import (
    ...
    TaxRateViewSet, UserProfileViewSet,
...
from taskboard.dropbox_views import drop_box, drafts, draft_detail, submit_draft
from taskboard.payment_views import (
    ...
    payment_request_amend, payment_request_cancel,
...
from realpay.api_views import (
    ...
    realpay_collections_analytics, realpay_recon_upload,
...
from integrations.claims_views import graphite_claims_register
...
from integrations.graphite_feeds_views import (
    graphite_feeds_list, graphite_feed_detail)
...
from commissions.broker_views import (            # noqa: E402
    ...
    broker_sync, broker_upload, broker_absorb,
)
urlpatterns += [
