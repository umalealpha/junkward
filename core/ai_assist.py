...
_ARIA_QC_TOOL_DESCRIPTIONS = {
    ...
    'approve_payment':      'Approve a payment request. CRITICAL: always show the user the payment details and get explicit YES before calling.',
    'reject_payment':       'Reject a payment request with a reason. Always confirm with the user first.',
