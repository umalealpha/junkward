...
from .models import AuditLog, Company, Currency, ExchangeRate, TaxRate, UserProfile
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'department', 'job_title', 'is_administrator', 'is_active', 'is_user_active',
...
class UserProfileWriteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'title', 'department', 'is_administrator', 'is_active',
        ]
        read_only_fields = ['id']
