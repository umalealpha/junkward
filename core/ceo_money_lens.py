...
def _large_claims(days=10):
    """Top 3 largest NEW claims registered in Graphite in the last `days` days.
    ...
    sql = (
        ...
        "  AND nc.reserve_amount IS NOT NULL AND nc.reserve_amount > 0 "
...
def money_lens(today=None):
    ...
    Returns {"period", "basis", "tiles"[4], "large_claims"[up to 3]}.
